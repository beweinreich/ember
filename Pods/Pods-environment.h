...
// KNMultiItemSelector
#define COCOAPODS_POD_AVAILABLE_KNMultiItemSelector
#define COCOAPODS_VERSION_MAJOR_KNMultiItemSelector 1
#define COCOAPODS_VERSION_MINOR_KNMultiItemSelector 0
#define COCOAPODS_VERSION_PATCH_KNMultiItemSelector 0
